...
class DirectionTest {
  ...
  void south_forwarding() {
    ...
    Location expected = Direction.SOUTH.forward().apply(location);
  ...
  void east_forwarding() {
    Location location = new Location(0, 0, new Grid(100, 100));
    Location expected = Direction.EAST.forward().apply(location);
  ...
  void north_forwarding() {
    ...
    Location expected = Direction.NORTH.forward().apply(location);
  ...
  void west_forwarding() {
    ...
    Location expected = Direction.WEST.forward().apply(location);
