...
class DirectionTest {
  ...
  void south_forwarding() {
    ...
    Direction.SOUTH.forwardLocation(location);
  ...
  void south_forwarding_limit_case() {
    ...
    Direction.SOUTH.forwardLocation(location);
    assertThat(location).isEqualTo(new Location(0, 100, new Grid(100, 100)));
  }

  @Test
  void east_forwarding() {
    Location location = new Location(0, 0, new Grid(100, 100));
    Direction.EAST.forwardLocation(location);
  ...
  void east_forwarding_limit_case() {
    ...
    Direction.EAST.forwardLocation(location);
    assertThat(location).isEqualTo(new Location(100, 0, new Grid(100, 100)));
  }

  @Test
  void north_forwarding() {
    Location location = new Location(0, 10, new Grid(100, 100));
    Direction.NORTH.forwardLocation(location);
  ...
  void west_forwarding() {
    ...
    Direction.WEST.forwardLocation(location);
